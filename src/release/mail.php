...
$mail_exist	= false;
$mail_to	= "";
$mail_url	= $register_url[$config_url_no];	// k2_confg.php,config.php参照
$url_token1	= "";
$url_token2	= "";
$url_token3	= "";
$pin_code	= "";
...
$sql_array = array(
	...
	"mail2"	=> "update k2g1_mail set mail_limit_time = (now() + interval 30 minute) where mail_hash = ?",
	"mail3"	=> "insert into k2g1_mail values(?,'',now() + interval 30 minute)",
	"mail4"	=> "update k2g1_mail set mail_pin_code = ? , mail_limit_time = (now() + interval 30 minute) where mail_hash = ?",
	"mail5"	=> "insert into k2g1_mail values(?,?,now() + interval 30 minute)"
);
